...
// A generic type for icon props to allow passing className, etc.
type IconProps = React.SVGProps<SVGSVGElement>;
// A type for the LogoIcon which renders an <img> tag.
type ImgIconProps = Omit<React.ImgHTMLAttributes<HTMLImageElement>, 'src' | 'alt'>;
...
export const ZaloIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 614.501 613.667" fill="currentColor" {...props}>
...
export const LogoIcon: React.FC<ImgIconProps> = (props) => (
